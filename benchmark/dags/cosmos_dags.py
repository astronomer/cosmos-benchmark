...
# ---------------------------------------------------------------------------
# WATCHER sensor memory vs. number of Cosmos task groups.
#
...
#
# 23k × 13 groups ≈ 1.55 GB at the large-manifest scale we wanted to characterise. Mitigation:
...
def _synthetic_watcher_task_group(group_index):
    ...
    return DbtTaskGroup(
        ...
        # whole life (matching how long-lived poke-mode sensors hold a worker slot), so debug mode
