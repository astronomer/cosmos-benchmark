...
#}
{# Modified 2026-05 by Astronomer / cosmos-benchmark.
   Upstream source (at our submodule's pinned commit):
   https://github.com/google/fhir-dbt-analytics/blob/80414cad9779ebe483f5feb4171fdc3b2464767b/models/metadata/unioned_thresholds.sql
   See the patch block below for the rationale. #}
{#
